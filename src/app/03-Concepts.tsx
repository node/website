const concepts = {
    tag: 'Concepts',
    title: '什么是平台工程？',
    description: '设计和构建工具链及工作流的学科，为云原生时代的软件工程组织提供自助服务能力。',
    items: [
        {
            title: '内部开发者平台 / 门户',
            description: '一站式治理配置、工具和机密蔓延。',
            icon: '',
        },
        {
            title: '万物即代码',
            description: '基础设施、数据、策略、可观测性，万物皆可为代码。',
            icon: '',
        },
        {
            title: '开发者体验',
            description: '打造流畅的，符合直觉的开发者控制面。',
            icon: '',
        },
        {
            title: 'GitOps',
            description: '为开发者构建基于 Git 的「单一事实来源」。',
            icon: '',
        },
    ],
    cta: {
        title: '深入理解平台工程',
        description: '掌握平台工程的概念、解决方案、和认知模型。 请查看我们编写的平台工程白皮书。',
        action: {
            title: '查看更多',
            link: '/concepts',
        },
        ...
        >
            <div className='container px-4 mx-auto'>
                <div className='xl:max-w-4xl mb-12 mx-auto text-center'>
                    ...
                    <h1 className='mb-4 text-3xl md:text-4xl leading-tight font-bold tracking-tighter' id="concepts">
                        {concepts.title}
                    </h1>
            ...
            <div className='container px-4 mx-auto'>
                <div className='max-w-4xl mx-auto text-center'>
                    ...
                    <p className='mb-6 text-lg md:text-xl font-heading font-medium text-coolGray-500'>
                        掌握平台工程的概念、解决方案、和认知模型。
                        请查看我们编写的平台工程白皮书。
                    </p>
                    <a
                        className='inline-block py-3 px-7 w-full md:w-auto text-lg leading-7 text-blue-50 bg-blue-500 hover:bg-blue-600 font-medium text-center focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 border border-transparent rounded-md shadow-sm'
                        href='#'
                    >
                        查看更多
                    </a>
